...
. Suchen Sie in System Manager nach der Feature Enable Identifier. Gehen Sie zu *menu:Einstellungen[System]* und scrollen Sie dann nach unten zu *Add-ons*. Suchen Sie nach der *Feature Enable Identifier*. Notieren Sie die Nummer für den Kennzeichner der Feature Enable.
...
+
.. Melden Sie sich bei an https://mysupport.netapp.com/site/["NetApp Support"^].
