...
summary: 'Zur dynamischen Steigerung der Systemperformance können Sie die am häufigsten abgerufenen Daten (wichtige Daten) auf Solid State Drives (SSDs) mit niedrigerer Latenz zwischenspeichern. SSD Cache wird ausschließlich für Host-Lesevorgänge verwendet.' 
---
