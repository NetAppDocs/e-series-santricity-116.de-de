...
+
** Wenn Ihr Snapshot-Volumen gelesen/geschrieben wird, wird das Dialogfeld *Kapazität überprüfen* angezeigt. Gehen Sie zu  3: Reserve capacity for a snapshot volume.
** Wenn Ihr Snapshot-Volumen schreibgeschützt ist, wird das Dialogfeld *Priorität bearbeiten* angezeigt. Gehen Sie zu  4: Edit settings for a snapshot volume.
