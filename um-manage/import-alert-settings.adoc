...
.Bevor Sie beginnen
* Warnmeldungen werden in SANtricity System Manager für das Speicherarray konfiguriert, das als Quelle verwendet werden soll (Menü:Einstellungen[Warnungen]).
